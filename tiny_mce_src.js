...
TinyMCE_Engine.prototype = {
	init : function(settings) {
		...
		if (!tinyMCE.baseURL) {
			...
			for (var i=0; i<elements.length; i++) {
				if (elements[i].src && (elements[i].src.indexOf("tiny_mce.js"/*tpa=http://220.130.50.232/irvingho/components/com_sobi2/includes/js/tiny_mce.js*/) != -1 || elements[i].src.indexOf("tiny_mce_dev.js"/*tpa=http://220.130.50.232/irvingho/components/com_sobi2/includes/js/tiny_mce_dev.js*/) != -1 || elements[i].src.indexOf("tiny_mce_src.js"/*tpa=http://220.130.50.232/irvingho/components/com_sobi2/includes/js/tiny_mce_src.js*/) != -1 || elements[i].src.indexOf("tiny_mce_gzip") != -1)) {
	...
	execCommand : function(command, user_interface, value) {
		...
		switch (command) {
			case 'mceHelp':
				tinyMCE.openWindow({
					file : 'http://220.130.50.232/irvingho/components/com_sobi2/includes/js/about.htm',
					width : 480,
					height : 380
				}, {
